...
echo -e "${CYAN}"
echo "################################################################"
echo "#     Start downloading and installing xstreamity_5.56         #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/147/refs/heads/main/enigma2-plugin-extensions-xstreamity_5.56.20260708_all.ipk"
IPK_NAME="enigma2-plugin-extensions-xstreamity_5.56.20260708_all.ipk"
